        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div
              ...
              style="background-position: center top 45%"
            ></div>
          </div>
...
<script>
import $ from "jquery";
import BackgroundImg1 from "../../../assets/img/ACbanner/BLOG_BODY_TORTEX_03-Thickness.jpg";
import BackgroundImg2 from "../../../assets/img/ACbanner/Web_Fender_1026_NPI_DuelPugilist_MarineLayer_Pedals_HPS_Desktop.jpg";

import BackgroundImg1RWD from "../../../assets/img/ACbanner/PICKRWD.jpg";
import BackgroundImg2RWD from "../../../assets/img/ACbanner/效果器-RWD.jpg";
...
BackgroundImg2RWD,BackgroundImg2RWD,
       ProductImages: {
  ...
  methods: {
      ...
      vm.$http.get(api).then((response) => {
        ...
        if (response.data.success) {
          ...
          vm.products = response.data.products.filter(
            (item) =>
              item.category.indexOf("AC") !== -1 &&
              item.category.indexOf(`${this.$route.query.id}` || `Capo`) !== -1
          );
        }
      });
    },
    ...
    addToCart(id, qty = 1, feature, num = 1) {
      const vm = this;
      console.log(vm.GString);
        console.log(vm.PickShow);
   console.log(feature);
...
feature=null;
    ...
    openDetailModal(item) {
      ...
      this.PickShow = false;
      this.GString = false;
      vm.quickProduct.feature="Please Select"
      console.log(vm.quickProduct.feature);
      //  console.log(vm.quickProduct);
      if (vm.quickProduct.category == "AC,Pick") {
        this.PickShow = true;
      
            // vm.quickProduct.feature=null
      } else {
        this.PickShow = false;
      }
      if (vm.quickProduct.category == "AC,GString") {
        this.GString = true;
          // vm.quickProduct.feature=null
