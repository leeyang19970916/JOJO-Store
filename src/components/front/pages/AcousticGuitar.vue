      ...
      <div class="row justify-content-center">
        ...
        <div id="productList" class="col-md-2 col-sm-3 col-12 text-start ml-5">
          <h3 class="h2 mb-4 text-dark" style="font-family: fantasy">
            ACOUSTIC<span class="mr-1">-</span>GUITARS
          </h3>
          <div
            id="productList-List"
            class="
...
<script>
import $ from "jquery";
import BackgroundImg2 from "../../../assets/img/AGbanner/ac_guitars_5646db3bf5eec43ebc831fc886855663.jpg";
import BackgroundImg1 from "../../../assets/img/AGbanner/banner-taylor-top.png";
// import BackgroundImg3 from "../../../assets/img/AGbanner/Brook-Montage.jpg";

import BackgroundImg2RWD from "../../../assets/img/AGbanner/yamaha-RWD.jpg";
import BackgroundImg1RWD from "../../../assets/img/AGbanner/banner-taylor-topRWD.png";
    ...
    getProduct(page = 1) {
      ...
      vm.$http.get(api).then((response) => {
        ...
        if (response.data.success) {
          ...
          console.log(vm.EleGuitarProduct[0].category);
           console.log(this.$route.query.id)
          vm.getNowPage = `${this.$route.query.id}`;
          vm.products = response.data.products.filter(
            (item) =>
      
              item.category.indexOf("AG") !== -1 &&
              item.category.indexOf(`${this.$route.query.id}` || `Martin`) !==
                -1
          );
        }
      });
